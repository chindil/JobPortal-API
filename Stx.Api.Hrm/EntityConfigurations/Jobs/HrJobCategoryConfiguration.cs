...
{
    public class HrJobCategoryConfiguration : IEntityTypeConfiguration<HrJobCategory>
    {
        public void Configure(EntityTypeBuilder<HrJobCategory> builder)
        {
            builder.ToTable(nameof(HrJobCategory));
