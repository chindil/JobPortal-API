...
{
    public class HrJobSpecialtyConfiguration : IEntityTypeConfiguration<HrJobSpecialty>
    {
        public void Configure(EntityTypeBuilder<HrJobSpecialty> builder)
        {
            builder.ToTable(nameof(HrJobSpecialty));
