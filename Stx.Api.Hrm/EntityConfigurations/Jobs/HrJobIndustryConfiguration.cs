...
{
    public class HrJobIndustryConfiguration : IEntityTypeConfiguration<HrJobIndustry>
    {
        public void Configure(EntityTypeBuilder<HrJobIndustry> builder)
        {
            builder.ToTable(nameof(HrJobIndustry));
