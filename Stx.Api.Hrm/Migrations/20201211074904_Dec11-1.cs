...
{
    public partial class Dec111 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillType = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HrJobCandidateSkill", x => new { x.JobCandidateID, x.SkillName });
                    table.ForeignKey(
                        name: "FK_HrJobCandidateSkill_HrJobCandidate_JobCandidateID",
