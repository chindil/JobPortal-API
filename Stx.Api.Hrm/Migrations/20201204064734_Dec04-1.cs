...
{
    public partial class Dec041 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StageCategory = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    IsConfidential = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IsLocked = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    SeqNum = table.Column<short>(type: "smallint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HrAtsWorkflow", x => x.ID);
                });
