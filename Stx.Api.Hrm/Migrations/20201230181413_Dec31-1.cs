...
{
    public partial class Dec311 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "HrReviewQuestion",
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JobOrderID = table.Column<int>(type: "int", nullable: false),
                    IsAutoEvaluate = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    FieldSrcData = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FieldType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Desc = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RequiredAnswer = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EvaluateCriteria = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EvaluateType = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HrReviewQuestion", x => new { x.JobOrderID, x.ID });
                });
        }
