...
{
    public partial class Nov252 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CorporateBenchmark_ModuelID_CorporateID_BmkCategory_BmkAttribute",
                table: "CorporateBenchmark",
                columns: new[] { "ModuelID", "CorporateID", "BmkCategory", "BmkAttribute" },
                unique: true,
                filter: "[BmkCategory] IS NOT NULL AND [BmkAttribute] IS NOT NULL");
        }
